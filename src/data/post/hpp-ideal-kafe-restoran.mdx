...
description: 'HPP ideal restoran Indonesia berkisar 28–35% dari revenue. Cafe dengan menu minuman dominan bisa lebih rendah, 25–30%. Pelajari cara menghitung, memantau, dan mengoptimalkan food cost bisnis F&B Anda.'
...
faq:
  ...
  - question: 'Berapa HPP ideal untuk cafe?'
    answer: 'HPP ideal untuk cafe yang didominasi minuman berkisar 25–30% dari revenue. Jika cafe juga menjual menu makanan berat, HPP total bisa naik ke kisaran 30–33%. Minuman memiliki margin yang lebih tinggi dari makanan karena biaya bahan bakunya relatif kecil dibandingkan harga jual.'
  ...
  - question: 'Bagaimana cara menghitung HPP restoran?'
    answer: 'Rumus HPP: (Stok Awal + Pembelian Bahan - Stok Akhir) dibagi Total Penjualan dikali 100%. Contoh: jika stok awal Rp5 juta, pembelian Rp20 juta, stok akhir Rp3 juta, dan penjualan Rp70 juta, maka HPP = (5+20-3) dibagi 70 dikali 100% = 31,4%. Ini masuk dalam rentang sehat untuk restoran.'
...
HPP 31,3% untuk restoran casual dining masuk dalam rentang sehat.

Untuk simulasi cepat HPP per menu, gunakan [Kalkulator HPP gratis dari Guslan.com](/tools/hpp-calculator) langsung di browser, tanpa instalasi.
...
Masih dalam rentang acceptable untuk menu nasi goreng. Tapi jika harga jualnya hanya Rp25.000, food cost-nya langsung melompat ke **50%** — tidak sehat.
...
**1. Standarisasi Recipe Card**
Buat recipe card detail untuk setiap menu: bahan, gramasi yang presisi, metode persiapan. Tempel di dapur. Ini intervensi paling cepat yang hasilnya paling langsung terasa.

**2. Update Harga Jual Secara Berkala**
Lakukan review harga setiap 3–6 bulan, atau segera setelah ada kenaikan bahan baku signifikan di atas 10%. Gunakan data HPP per menu sebagai basis, bukan perkiraan atau harga kompetitor.

**3. Terapkan FIFO di Gudang Bahan**
First In, First Out: bahan yang lebih lama masuk harus digunakan lebih dulu. Ini secara langsung mengurangi spoilage.
...
Identifikasi menu yang food cost-nya tinggi tapi penjualannya rendah. Menu ini adalah kandidat pertama untuk direvisi resepnya, dinaikkan harganya, atau dihapus dari daftar menu.
...
Ingin tahu berapa HPP aktual bisnis F&B Anda saat ini dan berapa potensi penghematan yang bisa dilakukan? [Hubungi Guslan Putra via WhatsApp](https://wa.me/628213141688) untuk konsultasi COGS Audit khusus restoran, cafe, dan bakery di Bali dan seluruh Indonesia.

---

_Baca juga: [Panduan Konsultan Keuangan Restoran](/blog/panduan-konsultan-keuangan-restoran) dan [Cara Membaca Laporan Laba Rugi Restoran](/blog/cara-baca-laporan-laba-rugi-restoran)_
